...
Pour cela, les sources sont multiples et se doivent d'être étudiées en fonction de leur coût : intérêts, prises de participation, indépendance dans le processus de décision.
...
Enfin, nos offres correspondent aux segments de marché visés et placent les intérêts de nos clients en haut lieu.
